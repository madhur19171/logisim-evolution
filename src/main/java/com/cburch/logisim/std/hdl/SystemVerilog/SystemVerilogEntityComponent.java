...
import com.cburch.logisim.hdl.vhdl.base.VhdlSimConstants;
...
public class SystemVerilogEntityComponent extends InstanceFactory {
  /**
  ...
  static class ContentAttribute extends Attribute<SystemVerilogContentComponent> {
    ...
    @Override
    public java.awt.Component getCellEditor(Window source, SystemVerilogContentComponent value) {
      final var proj = (source instanceof Frame frame) ? frame.getProject() : null;
      return SystemVerilogEntityAttributes.getContentEditor(source, value, proj);
    }

    @Override
    public SystemVerilogContentComponent parse(String value) {
      SystemVerilogContentComponent content = SystemVerilogContentComponent.create();
      if (!content.compare(value)) content.setContent(value);
      return content;
    }

    @Override
    public String toDisplayString(SystemVerilogContentComponent value) {
      return S.get("vhdlContentValue");
    }

    @Override
    public String toStandardString(SystemVerilogContentComponent value) {
  ...
  static final Logger logger = LoggerFactory.getLogger(SystemVerilogEntityComponent.class);

  public static final Attribute<SystemVerilogContentComponent> CONTENT_ATTR = new ContentAttribute();
  ...
  public SystemVerilogEntityComponent() {
    super(_ID, S.getter("vhdlComponent"), new SystemVerilogHdlGeneratorFactory(), true);
  ...
  public void setSimName(AttributeSet attrs, String SName) {
    ...
    final var atrs = (SystemVerilogEntityAttributes) attrs;
  ...
  public AttributeSet createAttributeSet() {
    return new SystemVerilogEntityAttributes();
  }
  ...
  void updatePorts(Instance instance) {
    SystemVerilogContentComponent content = instance.getAttributeValue(CONTENT_ATTR);
