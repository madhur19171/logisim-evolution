...
public class SystemVerilogEntityAttributes extends AbstractAttributeSet {
  ...
  private static final List<Attribute<?>> attributes =
      Arrays.asList(
          SystemVerilogEntityComponent.CONTENT_ATTR,
          StdAttr.LABEL,
          StdAttr.LABEL_FONT,
  ...
  private SystemVerilogContentComponent content;
  private String label = "";
  private Font labelFont = StdAttr.DEFAULT_LABEL_FONT;
  private Boolean labelVisible = false;
  private String simName = "";

  SystemVerilogEntityAttributes() {
    content = SystemVerilogContentComponent.create();
  }

  @Override
  protected void copyInto(AbstractAttributeSet dest) {
    final var attr = (SystemVerilogEntityAttributes) dest;
  ...
  public <V> V getValue(Attribute<V> attr) {
    if (attr == SystemVerilogEntityComponent.CONTENT_ATTR) {
      return (V) content;
    }
  ...
  public <V> void setValue(Attribute<V> attr, V value) {
    if (attr == SystemVerilogEntityComponent.CONTENT_ATTR) {
      final var newContent = (SystemVerilogContentComponent) value;
