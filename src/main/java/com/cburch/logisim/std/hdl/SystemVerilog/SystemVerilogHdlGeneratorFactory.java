...
public class SystemVerilogHdlGeneratorFactory extends AbstractHdlGeneratorFactory {

  public static final String HDL_DIRECTORY = "circuit";

  public SystemVerilogHdlGeneratorFactory() {
    super(HDL_DIRECTORY);
  ...
  public void getGenerationTimeWiresPorts(Netlist theNetlist, AttributeSet attrs) {
    final var contents = attrs.getValue(SystemVerilogEntityComponent.CONTENT_ATTR);
  ...
  public ArrayList<String> getArchitecture(
    ...
    SystemVerilogContentComponent content = attrs.getValue(SystemVerilogEntityComponent.CONTENT_ATTR);
