 ...
 */
public class SystemVerilogSimulatorTclComp {

  static final Logger logger = LoggerFactory.getLogger(SystemVerilogSimulatorTclComp.class);

  private boolean valid = false;
  private final SystemVerilogSimulatorTop vsim;

  public SystemVerilogSimulatorTclComp(SystemVerilogSimulatorTop vs) {
    vsim = vs;
  }
