 ...
 */
public class SystemVerilogSimulatorTclBinder {

  static final Logger logger = LoggerFactory.getLogger(SystemVerilogSimulatorTclBinder.class);

  private ProcessBuilder builder;
  private Process process;
  private Boolean running = false;

  private SystemVerilogSimulatorTop vsim = null;

  public SystemVerilogSimulatorTclBinder(SystemVerilogSimulatorTop vs) {
    vsim = vs;
    ...
    new Thread(
            () -> {
              ...
              try {
                ...
                userInfoBox.show();
                vsim.setState(VhdlSimConstants.State.ENABLED);
