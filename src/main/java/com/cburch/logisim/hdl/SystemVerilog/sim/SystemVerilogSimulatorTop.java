...
package com.cburch.logisim.hdl.SystemVerilog.sim;
...
import com.cburch.logisim.hdl.vhdl.base.VhdlSimConstants.State;
 ...
 * @since 2.12.0
 */
public class SystemVerilogSimulatorTop implements CircuitListener {

  private final SystemVerilogSimulatorSystemVerilogTop vhdlTop = new SystemVerilogSimulatorSystemVerilogTop(this);
  private final SystemVerilogSimulatorTclComp tclRun = new SystemVerilogSimulatorTclComp(this);
  private SystemVerilogSimulatorTclBinder tclBinder;
  private final SocketClient socketClient = new SocketClient();

  public static final Logger logger = LoggerFactory.getLogger(SystemVerilogSimulatorTop.class);

  private final Project project;

  private static final ArrayList<SystemVerilogSimulatorListener> listeners =
      new ArrayList<>();

  private State state = State.DISABLED;

  public SystemVerilogSimulatorTop(Project circuitState) {
    this.project = circuitState;
  }

  public void addVhdlSimStateListener(SystemVerilogSimulatorListener l) {
    listeners.add(l);
  }
  ...
  public void enable() {
     ...
     */
    if (tclBinder == null) {
      tclBinder = new SystemVerilogSimulatorTclBinder(this);
    }
  ...
  private void fireVhdlSimStateChanged() {
    for (SystemVerilogSimulatorListener l : listeners) {
      l.stateChanged();
    }
  }
  ...
  public void generateFiles() {
    ...
    try {
      ...
      SystemVerilogSimulatorTop.logger.error("Cannot copy simulation files: {}", e.getMessage());
      e.printStackTrace();
    }
  ...
  public void removeVhdlSimStateListener(SystemVerilogSimulatorListener l) {
    listeners.remove(l);
  }
