...
import com.cburch.logisim.hdl.vhdl.base.VhdlEntityAttributes;
import com.cburch.logisim.hdl.vhdl.base.VhdlParser;
 ...
 */
public class SystemVerilogSimulatorSystemVerilogTop {
  static final Logger logger = LoggerFactory.getLogger(SystemVerilogSimulatorSystemVerilogTop.class);
  private boolean valid = false;
  private final SystemVerilogSimulatorTop vhdlSimulator;
  private boolean firstPort;
  private boolean firstComp;
  private boolean firstMap;

  SystemVerilogSimulatorSystemVerilogTop(SystemVerilogSimulatorTop vs) {
    vhdlSimulator = vs;
  }
