...
public class HdlToolbarModel extends AbstractToolbarModel implements HdlModelListener {
  ...
  public HdlToolbarModel(Project proj, HdlContentView editor) {
    ...
    hdlImport = new HdlToolbarItem(new HdlIcon(HDL_IMPORT), HDL_IMPORT, Strings.S.getter("hdlOpenButton"));
    hdlExport = new HdlToolbarItem(new HdlIcon(HDL_EXPORT), HDL_EXPORT, Strings.S.getter("hdlSaveButton"));
    hdlValidate = new HdlToolbarItem(new HdlIcon(HDL_VALIDATE), HDL_VALIDATE, Strings.S.getter("validateButton"));
