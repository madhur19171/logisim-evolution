...
package com.cburch.logisim.hdl.gui;

import com.cburch.contracts.BaseDocumentListenerContract;
import com.cburch.logisim.gui.generic.OptionPane;
import com.cburch.logisim.hdl.vhdl.Strings;
...
public class HdlContentEditor extends JDialog implements JInputDialog {
  ...
  private class FrameListener extends WindowAdapter implements ActionListener, LocaleListener {
        ...
        if (choice == JFileChooser.APPROVE_OPTION) {
          ...
          try {
            ...
            OptionPane.showMessageDialog(
                ...
                e.getMessage(),
                Strings.S.get("hexSaveErrorTitle"),
    ...
    public void localeChanged() {
      setTitle(Strings.S.get("hdlFrameTitle"));
      open.setText(Strings.S.get("hdlOpenButton"));
      save.setText(Strings.S.get("hdlSaveButton"));
      validate.setText(Strings.S.get("validateAndSaveButton"));
      close.setText(Strings.S.get("closeButton"));
    }
  ...
  public static boolean confirmImport(Component parent) {
    String[] options = {Strings.S.get("importOption"), Strings.S.get("cancelOption")};
    return OptionPane.showOptionDialog(
            parent,
            Strings.S.get("importMessage"),
            Strings.S.get("importTitle"),
            0,
  ...
  private void close() {
    ...
    Object[] options = {
      Strings.S.get("confirmCloseYes"), Strings.S.get("confirmCloseNo"), Strings.S.get("confirmCloseBackup")
    };
    int n =
        OptionPane.showOptionDialog(
            this,
            Strings.S.get("confirmCloseMessage"),
            Strings.S.get("confirmCloseTitle"),
